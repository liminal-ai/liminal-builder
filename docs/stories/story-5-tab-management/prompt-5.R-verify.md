...
**Expected:** All tests PASS, zero failures. The 14 new tabs tests should appear alongside all prior story tests.
...
9. Refresh browser -- verify tabs restore from localStorage (early smoke check for TC-5.6a behavior; formal TC-5.6a coverage remains in Story 6)
...
4. All 14 TC IDs present in test descriptions
5. All 10 implementation spot checks confirmed

## Done When

- [ ] 72 tests PASS (58 previous + 14 new)
