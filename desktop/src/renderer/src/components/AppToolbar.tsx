    ...
    <header className="lb-toolbar-shell lb-drag-region" style={style}>
      ...
      <div className="lb-toolbar lb-no-drag-region">
        <div className="lb-toolbar-left">
          ...
          {context ? <span className="lb-toolbar-context">{context}</span> : null}
          <button type="button" className="lb-toolbar-ellipsis-btn" aria-label="More thread actions">
            ⋯
          </button>
        </div>

        <div className="lb-toolbar-right">
          <button type="button" className="lb-toolbar-icon-btn" aria-label="Run">
            <span className="lb-icon-triangle" />
          </button>
          <button type="button" className="lb-toolbar-btn" aria-label="Open menu">
            <span className="lb-toolbar-btn-dot" /> Open
            <span className="lb-toolbar-chevron">▾</span>
          </button>
          <button type="button" className="lb-toolbar-btn" aria-label="Commit menu">
            <span className="lb-toolbar-sliders" /> Commit
            <span className="lb-toolbar-chevron">▾</span>
          </button>
          <span className="lb-toolbar-separator" />
          <button type="button" className="lb-toolbar-icon-btn" aria-label="Panel">
            <span className="lb-icon-square" />
          </button>
          <button type="button" className="lb-toolbar-icon-btn" aria-label="Diff view">
            <span className="lb-icon-copy" />
          </button>
          <div className="lb-toolbar-metric" aria-label="Metrics">
